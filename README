...
[this_file](https://github.com/kallaballa/LoungeControl/edit/master/README)

[project_url](https://github.com/kallaballa/LoungeControl/)
...
#### Features ####
  ...
  ##### Movie Controls: #####
    ...
    live stream any movie or audio file from your harddisc to the amplifier or the screen 
    [beamer coming as soon as we got the remote control integrated into the system ;) ]
